 ...
 *
 * Drawn inline rather than pulled from an icon set. The project's lucide
 * version dropped its brand glyphs, and the alternatives all mean either
 * shipping a second icon dependency for four shapes or loading images that
 * cannot inherit `currentColor` — which these need to do, because the links
 * fade from bone to the beat's accent on hover like everything else in the HUD.
 *
 * All four are authored on the same 24-unit grid and as solid fills, so they
 * hold their weight against each other at the 14px the HUD draws them at.
 * Outline versions of these marks go muddy below about 20px.
 */
...
export const SOCIAL_LINKS: SocialLink[] = [
  { id: 'linkedin', label: 'LinkedIn', href: 'https://www.linkedin.com', Icon: LinkedInIcon },
  { id: 'instagram', label: 'Instagram', href: 'https://www.instagram.com', Icon: InstagramIcon },
  { id: 'youtube', label: 'YouTube', href: 'https://www.youtube.com', Icon: YouTubeIcon },
